...
/// </summary>
public class WellbeingEventSourcing
{
    private readonly CorrespondenceService _correspondenceService;
    private readonly ILogger<WellbeingEventSourcing> _logger;

    public WellbeingEventSourcing(ILogger<WellbeingEventSourcing> log, CorrespondenceService correspondenceService)
    {
        _logger = log;
